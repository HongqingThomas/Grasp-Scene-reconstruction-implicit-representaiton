...
# class LocalVoxelEncoderHP(nn.Module):
#     ''' 3D-convolutional encoder network for voxel input.
...
#     def __init__(self, dim=3, c_dim=128, unet=False, unet_kwargs=None, unet3d=False, unet3d_kwargs=None, 
#                  plane_resolution=512, grid_resolution=64, plane_type='xz', kernel_size=3, padding=0.1):
#         super().__init__()
#         self.actvn = F.relu
#         if kernel_size == 1:
#             self.conv_in = nn.Conv3d(1, c_dim, 1)
...
class LocalVoxelEncoderHP(nn.Module):
    ...
    def __init__(self, dim=3, c_dim=128, unet=False, unet_kwargs=None, unet3d=False, unet3d_kwargs=None, 
                 plane_resolution=512, grid_resolution=64, plane_type='xz', kernel_size=3, padding=0.1): # plane_resolution=512, grid_resolution=64
        super().__init__()
        self.actvn = F.relu
        if kernel_size == 1:
            self.conv_in = nn.Conv3d(1, c_dim, 1)
