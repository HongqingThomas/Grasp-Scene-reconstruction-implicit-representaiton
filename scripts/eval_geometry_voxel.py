...
def main(args):
    ...
    kwargs = {"num_workers": 2, "pin_memory": True} if use_cuda else {} # "num_workers": 8
...
def create_test_loader(root, root_raw, kwargs, ROI, num_point_occ=100): # num_point_occ=100000
    # load the dataset
